...
export interface RoutingV2Interface extends utils.Interface {
  functions: {
    "changeTokenBridge(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "changeTokenBridge",
...
export interface RoutingV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RoutingV2Interface;
  ...
  functions: {
    changeTokenBridge(
      tokenBridgeAdr: PromiseOrValue<string>,
