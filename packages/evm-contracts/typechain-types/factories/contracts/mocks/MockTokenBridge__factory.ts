...
import type {
  MockTokenBridge,
  MockTokenBridgeInterface,
} from "../../../contracts/mocks/MockTokenBridge";
...
type MockTokenBridgeConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: MockTokenBridgeConstructorParams
...
export class MockTokenBridge__factory extends ContractFactory {
  ...
  override attach(address: string): MockTokenBridge {
    return super.attach(address) as MockTokenBridge;
  }
  override connect(signer: Signer): MockTokenBridge__factory {
    return super.connect(signer) as MockTokenBridge__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): MockTokenBridgeInterface {
    return new utils.Interface(_abi) as MockTokenBridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MockTokenBridge {
    return new Contract(address, _abi, signerOrProvider) as MockTokenBridge;
  }
}
