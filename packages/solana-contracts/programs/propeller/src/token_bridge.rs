...
pub const MAINNET_WH_BRIDGE: Pubkey = Pubkey::new_from_array([
	14, 10, 88, 154, 65, 165, 95, 189, 102, 197, 42, 71, 95, 45, 146, 166,
	211, 220, 155, 71, 71, 17, 76, 185, 175, 130, 90, 152, 181, 69, 211, 206
]);
pub const MAINNET_WH_TOKEN_BRIDGE: Pubkey = Pubkey::new_from_array(
	[14, 10, 88, 158, 100, 136, 20, 122, 148, 220, 250, 89, 43, 144, 253, 212, 17, 82, 187, 44, 167, 123, 246, 1, 103, 88, 166, 244, 223, 157, 33, 180]
);
pub const TESTNET_WH_BRIDGE: Pubkey = Pubkey::new_from_array(
	[43, 18, 70, 201, 238, 250, 60, 70, 103, 146, 37, 49, 17, 243, 95, 236, 30, 232, 238, 94, 157, 235, 196, 18, 210, 233, 173, 173, 254, 205, 204, 114]
);
pub const TESTNET_WH_TOKEN_BRIDGE: Pubkey = Pubkey::new_from_array(
	[186, 178, 144, 69, 74, 141, 253, 176, 134, 178, 102, 106, 116, 82, 57, 139, 174, 25, 147, 150, 146, 51, 183, 216, 207, 204, 154, 27, 0, 1, 208, 221]
);
