...
const devnetPools: readonly PoolSpec[] = [
  ...
  },
  {
    ...
    isStableSwap: true,
    contract: "SWimmSE5hgWsEruwPBLBVAFi3KyVfe8URU2pb4w7GZs",
    address: "3WoCCA8XQ23GuuyhmKDZ5mQb4g2skFa1p2oecqZcPfXQ",
    authority: "E54JnZ2FwQf9qddjsDbGaTj6gPs7cp2wZ2hgG5dtkxB2",
    feeDecimals: 6,
    lpToken: "devnet-solana-lp-meta-karura-ausd",
    tokenAccounts: new Map([
      ["devnet-karura-ausd", "8xLcJoS4JEzWs61V8qBToiT7qNgNWqQAmnCSYJ3V87Mu"],
      [
        "devnet-solana-lp-hexapool",
        "AqztguLmEn1HDHjTtDvYotfeyMCAmWGjsCnBQCMcm8Dj",
      ],
    ]),
  },
  {
  ...
  },
  {
    ...
    isStableSwap: true,
    contract: "SWimmSE5hgWsEruwPBLBVAFi3KyVfe8URU2pb4w7GZs",
    address: "GgVfECFTq1rbJRyXzGyHroXrDgy2hKw78H8DtjL5tdyX",
    authority: "ErC9Q8qJifEpggejKnJF6sfLbUY9tY3uvAFH5u1U4j56",
    feeDecimals: 6,
    lpToken: "devnet-solana-lp-meta-acala-ausd",
    tokenAccounts: new Map([
      ["devnet-acala-ausd", "9ZzN3gFq9L7fJvs5eXvM9LGZFUM19JMepnS2wosYCXiV"],
      [
        "devnet-solana-lp-hexapool",
        "BmzAMVUPfGnk1X5y6e13CPd8VuzG5C3tYiajTzi6XXZN",
      ],
    ]),
  },
  {
