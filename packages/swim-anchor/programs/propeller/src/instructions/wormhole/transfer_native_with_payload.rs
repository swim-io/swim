...
use crate::{Propeller, PropellerError, PropellerSender, SwimPayload, SwimPayloadVersion, TOKEN_COUNT, TRANSFER_NATIVE_WITH_PAYLOAD_INSTRUCTION, TransferWithPayloadData};
...
pub fn handle_transfer_native_with_payload(
	...
	let swim_payload = SwimPayload {
		...
		relayer_fee: U256::from(propeller.relayer_fee),
		gas_kickstart,
	};
