...
export interface PoolInterface extends utils.Interface {
  functions: {
    ...
    "ampInitialValue()": FunctionFragment;
    "ampTargetTimestamp()": FunctionFragment;
    "ampTargetValue()": FunctionFragment;
    ...
    "initialize(string,string,address,int8,address[],int8[],uint32,uint32,uint32,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ampInitialValue",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "ampTargetValue",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Pool extends BaseContract {
  ...
  functions: {
    ...
    ampInitialValue(overrides?: CallOverrides): Promise<[number]>;

    ampTargetTimestamp(overrides?: CallOverrides): Promise<[number]>;

    ampTargetValue(overrides?: CallOverrides): Promise<[number]>;
    ...
    initialize(
      ...
      lpTokenImpl: PromiseOrValue<string>,
  ...
  estimateGas: {
    ...
    ampInitialValue(overrides?: CallOverrides): Promise<BigNumber>;

    ampTargetTimestamp(overrides?: CallOverrides): Promise<BigNumber>;

    ampTargetValue(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ampInitialValue(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    ampTargetTimestamp(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    ampTargetValue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
